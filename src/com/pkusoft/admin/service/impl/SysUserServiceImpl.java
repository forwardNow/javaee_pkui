...
public class SysUserServiceImpl extends BaseServiceImpl<SysUser> implements SysUserService{
	...
	public int insertSysUser(SysUser sysUser, Long[] roleId) {
		...
		sysUser.setSalt("a");
		String password = DigestUtils.sha1Hex(sysUser.getPassword(), sysUser.getSalt(), /*ShiroDbRealm.HASH_ITERATIONS*/ 1024);
...
//			        SysParaCache.getSysParaValue(ParaCode.ADMIN_DEFAULT_PASSWORD),
					sysParaService.get( ParaCode.ADMIN_DEFAULT_PASSWORD ).getParaValue(),
			        sysUser.getSalt(),
			        /*ShiroDbRealm.HASH_ITERATIONS*/ 1024
			);
			sysUser.setPassword(password);
			this.update(sysUser);

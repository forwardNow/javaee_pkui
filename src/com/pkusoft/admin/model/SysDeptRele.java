 ...
 * @author 
 */
public class SysDeptRele extends BaseModel  implements Serializable {
	/**序列化版本号*/
	...
	/**数据归属单位名称*/
	private java.lang.String releDeptName;
	 ...
	 */
	public java.lang.String getReleDeptName(){
		return this.releDeptName;
	}
	 ...
	 */
	public void setReleDeptName(java.lang.String releDeptName){
		this.releDeptName = releDeptName;
	}

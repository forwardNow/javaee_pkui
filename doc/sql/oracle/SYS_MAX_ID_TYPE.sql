...
-- ----------------------------
DROP TABLE "SYS_MAX_ID_TYPE";
CREATE TABLE "SYS_MAX_ID_TYPE" (   "ID_TYPE" VARCHAR2(6CHAR) NOT NULL, "ID_NAME" VARCHAR2(30CHAR), "ID_SIZE" NUMBER(16,0) NOT NULL, "ID_LOOP" VARCHAR2(1CHAR) NOT NULL, "ID_BEGIN" NUMBER(16,0) NOT NULL, "ID_END" NUMBER(16,0) NOT NULL, "ID_DES" VARCHAR2(128CHAR));
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_TYPE" IS '编号类型';
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_NAME" IS '编号名称';
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_SIZE" IS '编号长度';
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_LOOP" IS '是否可循环使用';
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_BEGIN" IS '开始值';
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_END" IS '最大值';
COMMENT ON COLUMN "SYS_MAX_ID_TYPE"."ID_DES" IS '描述';
...
-- ----------------------------
--  Primary key structure for table "SYS_MAX_ID_TYPE"
-- ----------------------------
ALTER TABLE "SYS_MAX_ID_TYPE" ADD CONSTRAINT "PK_SYS_MAX_ID_TYPE" PRIMARY KEY("ID_TYPE");

-- ----------------------------
--  Comment for table "SYS_MAX_ID_TYPE"
-- ----------------------------
COMMENT ON TABLE "SYS_MAX_ID_TYPE" IS '最大编号类型表';
